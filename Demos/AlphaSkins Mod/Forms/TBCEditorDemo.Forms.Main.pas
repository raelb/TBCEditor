...
uses
  ...
  VirtualTrees, BCControl.ObjectInspector, Vcl.ImgList, acAlphaImageList;
...
// to Enable VCL Styles do 2 things uncomment line "TrySetStyle" in Project source.
var
...
begin
  ...
  if USE_VCL_STYLES then
  begin
    ObjectInspector.UseVCLStyles := True;
    SkinManager.Active := False;
    SelectedHighlighterColorClick('Monokai');
  end
  else
  begin
